...
g <- ggplot(data = HSUGIS_I, aes(x = Month_I_M, y = Inquiries, group = FiscalYear_I, colour=FiscalYear_I)) + 
     geom_line(size = 1) +
     geom_point() +
     theme_bw()+
...
```{r WADC, fig.height=4, fig.width=8, include=FALSE, eval=FALSE}
FY <- c("FY18", "FY19", "FY20", "FY21")
Inquiries <- DAA4 %>% filter(Stealth == "Not Stealth")
WADC_I <- Inquiries %>%
  filter(
...
```{r fig.height=4, fig.width=8, include=FALSE, eval=FALSE}
g
```
...
```{r  CUGRIS, fig.height=4, fig.width=8, include=FALSE, eval=FALSE}
FY <- c("FY18", "FY19", "FY20", "FY21")
Inquiries <- DAA4 %>% filter(Stealth == "Not Stealth")
CUGRIS_I <- Inquiries %>%
  filter(
...
```{r  WAGRIS, fig.height=4, fig.width=8, include=FALSE, eval=FALSE}
FY <- c("FY18", "FY19", "FY20", "FY21")
Inquiries <- DAA4 %>% filter(Stealth == "Not Stealth")
WAGRIS_I <- Inquiries %>%
  filter(
...
```{r  CUGROS, fig.height=4, fig.width=8, include=FALSE, eval=FALSE}
FY <- c("FY18", "FY19", "FY20", "FY21")
Inquiries <- DAA4 %>% filter(Stealth == "Not Stealth")
CUGROS_I <- Inquiries %>%
  filter(
...
```{r  WAGROS, fig.height=4, fig.width=8, include=FALSE, eval=FALSE}
FY <- c("FY18", "FY19", "FY20", "FY21")
Inquiries <- DAA4 %>% filter(Stealth == "Not Stealth")
WAGROS_I <- Inquiries %>%
  filter(
...
```{r  test, fig.height=4, fig.width=8, include=FALSE, eval=FALSE}
