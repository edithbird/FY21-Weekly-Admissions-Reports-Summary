...
<input type="checkbox" checked> Task 1</input>

<input type="checkbox"> Task2</input> 
                        ...
                        AgeGroupforTransfers = ifelse(AgeGroup == "Unknown", "Unknown Age",
                                                      ifelse(Age_Y >= 0 & Age_Y < 19, "Too Young", 
                                                        ifelse(Age_Y > 24, "Too Old", 
                                                          ifelse(Age_Y >=19 & Age_Y <= 24, "Transfer Age","Unknown"))))) %>% group_by()
...
### Undergraduate Degree for In-State High School Students Inquiries



```{r}
unique(DAA4$AgeGroup)
kable(DAA4 %>% 
...
### Undergraduate Degree for Out-of-State High School Students Inquiries
...
### Transfer In-State Inquiries
, AgeGroupforTransfers
```{r}
unique(DAA4$AgeGroupforTransfers)
...
### Transfer Out-of-State Inquiries
...
### Inquiries Graduate In-State Current Undergrads
...
### Inquiries Graduate In-State Working Adults
...
### Inquiries Graduate Out-of-State Current Undergrads
...
### Inquiries Graduate Out-of-State Working Adults
...
### Applications Undergraduate Degree for In-State High School Students Applicants
...
### Applicants Undergraduate Degree for Out-of-State High School Students
...
### Applicants Transfer Out-of-State
...
### Applicants Graduate In-State CU
...
### Applicants Graduate In-State WA
...
### Applicants Graduate Out-of-State CU
...
### Applicants Graduate Out-of-State WA
