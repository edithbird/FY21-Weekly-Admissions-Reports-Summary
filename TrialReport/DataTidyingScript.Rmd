...
AllFunnelIandA <- AllFunnelIandA %>% mutate(DateCollected = as.Date("2020-11-10"))
...
```{r}
iris_ss <- gs_new("FY21_Weekly_Enrollment_Funnel", input = AllFunnelIandA, trim = TRUE)
```
